...
function draw() {
    ...
    textSize(24);
    textAlign(CENTER, CENTER);
    let storytext = ["I am Ian", "I like pizza", "pizza...", "PIZZA...", "PIZZA = CHEESE", "I NEED CHEESE", "I want some pizza", "I will go get pizza now", "I also want some fries", "IAN ALSO WANT IC", "THE END"]
